...
study benchmarks 25 exactly reconstructable variants and two archival variants
with incomplete resolved-configuration provenance across 38 input configurations using
...
worse but is not part of that historical family. This inferential family is an
artifact-based post-selection analysis of preserved historical predictions.
In a matched 14-condition ablation, vibration alone gives 0.0217~\(\upmu\)m
versus 0.0210~\(\upmu\)m for fusion, so the observed mean-level contribution
of AE is below the practical metrology scale.
