...
\item
  ...
  favourable by point estimate but not significant. A secondary five-seed
  sensitivity analysis corroborates this pattern. The ranking among the
...
\item
	  The modality ablation indicates that vibration carries most of the
	  predictive signal in the present setup, with AE giving only a small
	  mean-level improvement.
\item
