...
\(y=x\) calibration. \textbf{a}, RF with AE-dB-z + Vib-dB-z. \textbf{b}, RF
with AE-log-mel + Vib-log-mel. \textbf{c}, RF with AE-dB-z + Vib-dB-z +
process parameters.}\label{fig:scatter-top3}
\end{figure}
...
the AE profile peaks at 334~kHz. \textbf{a}, AE attribution profiles.
\textbf{b}, Vibration attribution profiles.}\label{fig:rf-oof-shap}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{shap_importance_LightGBMModel_ae_spec+vib_spec.png}
\caption{Explainability analysis. \textbf{a}, TreeSHAP mean absolute
importance for the top AE frequency bins (LightGBM on
AE-dB + Vib-dB), labelled by physical frequency.
\textbf{b}, Grad-CAM frequency
...
\begin{figure}
\centering
\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{mc_dropout_intervals_ResNetVibCNN_vib_spec.png}
...
\begin{figure}
\centering
\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{mc_dropout_reliability.png}
...
\begin{figure}
\centering
\includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio]{results_uncertainty_calibration.png}
...
\begin{figure}
\centering
\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{rf_conformal_intervals.png}
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{results_condition_error_bars.png}
...
\path{edge_latency_benchmark_per_fold.csv}. Random forest on dB-z has
