...
\caption{Complete LOGO-only model inventory. The archived canonical benchmark contains 25 exactly reconstructable variants and two archival variants with incomplete resolved-configuration provenance across 38 distinct input configurations.}\label{tab:supp-model-inventory}\\
\toprule
